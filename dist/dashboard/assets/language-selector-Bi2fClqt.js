import{i_ as c,gS as n,jb as b,iZ as m,f$ as L,bc as p,fT as d,dy as f}from"./index-B_AGHcrO.js";function v(e){const{formatLanguageName:l}=c();return n.useMemo(()=>(e??[]).map(a=>({code:a,label:l(a)})).sort((a,s)=>a.label.localeCompare(s.label)),[e,l])}const y=d(`
