...
exports.V361779843269472 = void 0;
const core_1 = require("@vendure/core");
class V361779843269472 {
    async up(queryRunner) {
        ...
        await (0, core_1.migrateProductOptionGroupData)(queryRunner);
        await queryRunner.query(`ALTER TABLE "product_option_group" DROP COLUMN "productId"`, undefined);
        await (0, core_1.migrateAssetTranslationData)(queryRunner);
...
exports.V361779843269472 = V361779843269472;
